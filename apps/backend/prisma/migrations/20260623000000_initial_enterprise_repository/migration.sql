...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('LOGIN_SUCCESS', 'LOGIN_FAILURE', 'LOGOUT', 'USER_CREATED', 'USER_UPDATED', 'ROLE_CREATED', 'PERMISSION_ASSIGNED', 'ACCESS_DENIED', 'FOLDER_CREATED', 'FILE_UPLOADED', 'FILE_DOWNLOADED', 'FILE_DELETED');
